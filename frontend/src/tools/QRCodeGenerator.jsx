...
import { ToolInput, ToolSlider, ToolButton, ToolResult, FieldGroup } from '@/components/ui-kit'
    ...
    <div className="flex flex-col gap-6">
      ...
      <ToolResult visible={!!qrImage}>
        <div className="text-center flex flex-col items-center">
          <div className="inline-block p-4 bg-white rounded-[var(--radius-md)] shadow-[var(--shadow-sm)] mb-4">
            <img
              src={qrImage}
