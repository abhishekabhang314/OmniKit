...
export default function PasswordGenerator() {
  ...
  const handleAction = async () => {
    if (!options.include_uppercase && !options.include_lowercase && !options.include_numbers && !options.include_symbols) {
    ...
    setCopied(false)
    try {
      const res = await axios.post('/api/generators/password', { 
